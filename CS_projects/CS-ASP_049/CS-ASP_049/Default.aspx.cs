    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            //removing a member via the key
            if (cars.Remove("V1"))
                result += "Successfully removed V1<br/>";
            
            for (int i = 0; i < cars.Count; i++)
            {
                result += "<h2>" + cars.ElementAt(i).Key + "</h2>" + cars.ElementAt(i).Value.FormatDetailsForDisplay();
            }
            

            /*
            //Getting value via the key instead of the element or member
            Car v2;
