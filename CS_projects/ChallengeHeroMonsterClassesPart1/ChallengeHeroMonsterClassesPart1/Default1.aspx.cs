...
namespace ChallengeHeroMonsterClassesPart1
{
    public partial class Default1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (hero.Health > 0 && monster.Health > 0)
            {
                ...
                {
                    monster.Defend(hero.Attack(heroRoll));
                }
                if (monster.AttackBonus == true)
                {
                    hero.Defend(monster.Attack(monsterRoll));
                }
                ...
                int monsterDamage = monster.Attack(heroRoll);
    ...
    public class Character
    {
        ...
        {
            characterRoll.Sides = DamageMaximum;
    ...
    public class Dice
    {
       ...
       public int Roll()
        {
            int characterRoll = random.Next(1, Sides);
