<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default1.aspx.cs" Inherits="MegaChallengeCasino.Default1" %>
...
<body>
    ...
    <div>
        ...
        <asp:Image ID="reelOne" runat="server" Height="150px" Width="150px" />
&nbsp;<asp:Image ID="reelTwo" runat="server" Height="150px" Width="150px" />
