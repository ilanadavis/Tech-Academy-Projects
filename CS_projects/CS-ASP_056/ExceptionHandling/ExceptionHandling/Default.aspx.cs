...
namespace ExceptionHandling
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void okButton_Click(object sender, EventArgs e)
        {
            ...
            {
                //Perform cleanup here. Probably won't need this until 
                //working with external resources like database connections, 
                //network connections, file system manipulations etc.
